                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Senha</th>
                            <th>...</th>
                            <th><a href='./admin/add.php' class='dash'><span class='material-icons-sharp success'>add_box</span></a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td class='success'>".$user_data['nome']."</td>";
                            echo "<td class='danger'>".$user_data['email']."</td>";
                            echo "<td class='warning'>".$user_data['senha']."</td>";
                            echo "<td>
                                <a href='./admin/edit.php?id=".$user_data['id']."' class='dash'>
                                    <span class='material-icons-sharp warning'>edit</span>          
                                </a>
                            </td>";
                            echo "<td>
                                <a href='./admin/view.php?id=".$user_data['id']."' class='dash'>
                                    <span class='material-icons-sharp success'>visibility</span>          
                                </a>
                            </td>";
                            echo "<td>
                                <a href='#' onclick='openPopup(" . $user_data['id'] . ")'> 
                    ...
                    <div class="container_modal">
                        <div class="popup" id="popup">
                            ...
                            <p style="">Atenção! Tem certeza que deseja prosseguir!</p>
                            <form id="delete-form" method="post">
                                <button style="margin-left: 10px; background: #b92632; margin-top: 30px; width: 40%; text-align: center; padding-top: 10px; font-size: 1rem; float: left;" type="button" class="button danger" onclick="closePopup()">Cancelar</button>
                                <button style="margin-left: 50px; margin-top: 30px; width: 40%; text-align: center; padding-top: 10px; font-size: 1rem; float: left;" type="submit" class="button success">Continuar</button>
                            </form>
                        </div>
                    </div>
