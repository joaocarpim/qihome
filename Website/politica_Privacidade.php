    ...
    <main class="main">
        <section class="home section" id="home">
            <div class="home__container container grid">
                ...
                <h2 aria-label="Nossa Política de privacidade segue abaixo" tabindex="0">Política de Privacidade</h2>
                <h2 aria-label="Primeira Política é a Proteção de dados" tabindex="0">1. Proteção de dados</h2>
                    <p tabindex="0">Na QiHome, levamos a sua privacidade a sério e nos comprometemos a proteger os seus dados pessoais. Esta política descreve como coletamos, 
                        utilizamos, armazenamos e protegemos as informações fornecidas por você ao utilizar nossos serviços. 
                        Ao utilizar nossos serviços, você concorda com as práticas descritas nesta política..</p>

                    <h2 aria-label="Segunda é a Coleta de informações" tabindex="0">2. Coleta de Informações</h2>
                    <p tabindex="0"> Para fornecer nossos serviços, podemos coletar informações pessoais, como nome, endereço de e-mail, número de telefone e outras informações relevantes. 
                        Essas informações podem ser fornecidas por você durante o processo de registro, uso do aplicativo móvel ou comunicação com nossa equipe de suporte. </p>

                    <h2 aria-label="Terceira consiste no Uso de Informações" tabindex="0">3. Uso de Informações</h2>
                    ...
                    <h2 aria-label="Na quarta, com a Segurança dos dados" tabindex="0">4. Segurança dos Dados</h2>
                    <p tabindex="0">Utilizamos medidas de segurança adequadas para proteger as informações pessoais dos usuários contra acesso não autorizado, alteração, divulgação ou destruição. 
                        Implementamos proteções técnicas, como criptografia de dados, e restrições de acesso para garantir a segurança dos dados coletados.</p>

                    <h2 aria-label="Quinta, o Acesso às Informações" tabindex="0">5. Acesso às Informações</h2>
                    <p tabindex="0">O acesso às informações pessoais é restrito apenas a funcionários autorizados que precisam dessas informações para desempenhar suas funções relacionadas 
                        aos serviços prestados. Todos os funcionários estão sujeitos a obrigações de confidencialidade.</p>

                    <h2 aria-label="Sexta, Retenção de dados" tabindex="0">6. Retenção de Dados</h2>
                    <p tabindex="0">Mantemos as informações pessoais apenas pelo tempo necessário para cumprir os propósitos para os quais foram coletadas, a menos que seja exigido por lei que os 
                        dados sejam retidos por mais tempo.Mantemos as informações pessoais apenas pelo tempo necessário para cumprir os propósitos para os quais foram coletadas, 
                        a menos que seja exigido por lei que os dados sejam retidos por mais tempo.</p>

                    <h2 aria-label="Sétima, Alterações na Política de Privacidade" tabindex="0">7. Alterações na Política de Privacidade</h2>
                    <p tabindex="0">Podemos atualizar esta política de privacidade periodicamente. As alterações entrarão em vigor assim que forem publicadas nesta página. 
                        Recomendamos que você revise esta política regularmente para estar ciente de quaisquer atualizações.</p>
                    
                    <h2 aria-label="Oitava, Direitos do Usuário" tabindex="0">8. Direitos do Usuário</h2>
                    <p tabindex="0"> Você tem o direito de acessar, corrigir ou excluir suas informações pessoais. Também pode solicitar a restrição ou oposição ao uso de seus dados pessoais. 
                        Entre em contato conosco para exercer esses direitos ou caso tenha alguma dúvida relacionada à privacidade.</p>
                        <br> 
                    <p tabindex="0">A QiHome está empenhada em proteger a sua privacidade e garantir a segurança dos seus dados pessoais. Se tiver alguma dúvida ou preocupação sobre 
                        esta política de privacidade, não hesite em nos contatar para obter mais informações.</p>
                    <br>
                </div>
            </div>
        </section>
