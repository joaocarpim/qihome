...
include_once('conexao.php');
    ...
    $sql = "SELECT * from tbl_status_sensor ORDER BY datahora DESC";
					...
					<table>
						...
						<tbody>
							...
							while ($dados = mysqli_fetch_assoc($result)) {
								echo "<tr>";
								echo "<td class='success'>".$dados['sensor']."</td>";
								echo "<td class='danger'>".$dados['estado']."</td>";
								echo "<td class='warning'>".date('d - m - Y', strtotime($dados['datahora']))."</td>";
								echo "<td class='warning'>".date('H:i:s', strtotime($dados['datahora']))."</td>";
								echo "</tr>";
							}
							?>
							</tbody>
